        ...
        <li class="nav-item dropdown no-arrow">
            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                ...
                <?php
                 ...
                 if ($this->session->userdata('image') !='') { ?>
                    <img class="img-profile rounded-circle" src="<?= base_url() ?>assets/img/user_images/<?= $this->session->userdata('image') ?>">
                <?php } else { ?>
            ...
            <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in" aria-labelledby="userDropdown">
                ...
                <a class="dropdown-item" href="<?= base_url() ?>user/change_password">
                    <i class="fa fa-unlock-alt text-gray-400 fa-sm fa-fw mr-2" aria-hidden="true"></i>
                    Change password
                </a>
            </div>
        </li>
