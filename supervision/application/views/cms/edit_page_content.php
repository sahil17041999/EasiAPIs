...
$page_title  =    $static_page_Info->page_title;
$page_id  =    $static_page_Info->page_id;
$page_seo_title = $static_page_Info->page_seo_title;
$page_position = $static_page_Info->page_position;
$page_seo_keyword = $static_page_Info->page_seo_keyword;
$page_seo_description = $static_page_Info->page_seo_description;
$page_description = $static_page_Info->page_description;
        ...
        <div class="container">
            ...
            <div class="card shadow mb-4">
                <div class="card-header py-3">
                    <h6 class="m-0 font-weight-bold text-primary">Edit Static page content</h6>
                </div>
                <div class="card-body">
                    <a class="btn btn-outline-primary btn-sm" href="<?= base_url() ?>cms/static_page_content">Back</a>
                    <form id="add_static_page" action="<?php echo base_url() ?>cms/edit_pages_content" method="post" role="form" class="mt-3">
                        <div class="box-body">
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="name">Page Title <span class="text-danger">*</span></label>
                                        <input type="text" value="<?= $page_title ?>" class="form-control" value="" name="page_title" id="page_title">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" value="<?= $page_seo_title ?>" class="form-control" name="page_seo_title" id="page_seo_title">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <select name="page_position" id="page_position" class="form-control">
                                            ...
                                            <option value="Top" <?php if (isset($page_position)) {
                                                                    if ($page_position == 'Top') {
                                                                        echo 'selected="selected"';
                                                                    }
                                                                } ?>>Top</option>
                                            <option value="Bottom" <?php if (isset($page_position)) {
                                                                        if ($page_position == 'Bottom') {
                                                                            echo 'selected="selected"';
                                                                        }
                                                                    } ?>>Bottom</option>
                                        </select>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="text" class="form-control" value="<?= $page_seo_keyword ?>" name="page_seo_keyword" id="page_seo_keyword">
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" value="<?= $page_seo_description ?>" name="page_seo_description" id="page_seo_description">
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <?php echo isset($page_description) ? $page_description : ''; ?>
                                        </textarea>
                                    </div>
                                </div>
                            </div>
